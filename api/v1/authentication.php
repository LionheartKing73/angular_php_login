...
$app->post('/login', function() use ($app) {
    ...
    $user = $db->getOneRecord("select uid,first_name,password,email,date from customers_auth where phone='$email' or email='$email'");
    if ($user != NULL) {
...
$app->post('/signUp', function() use ($app) {
    ...
    if(!$isUserExists){
        ...
        $column_names = array('phone', 'first_name', 'last_name', 'email','country','currency', 'password', 'date');
